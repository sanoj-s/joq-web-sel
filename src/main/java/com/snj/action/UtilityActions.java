...
public class UtilityActions extends AutomationEngine {
	...
	GeneralUtilities generalUtils = new GeneralUtilities();
	...
	public String takeScreenshot(WebDriver driver, String fileName) throws AutomationException {
		try {
			...
			String destination = System.getProperty("user.dir") + "/screenshots/" + fileName + "_"
					+ generalUtils.getCurrentDate() + "_" + "screenshot.jpg";
